...
namespace SuperBitBros.MarioPower
{
    public class StandardMarioPower : AbstractMarioPower
    {
        ...
        public override AnimatedTexture GetTexture()
        {
            ...
            // SWIM LEFT
            atexture.Add(4, Textures.mario_small_sheet.GetTextureWrapper(8, 0));
            atexture.Add(4, Textures.mario_small_sheet.GetTextureWrapper(9, 0));
            atexture.Add(4, Textures.mario_small_sheet.GetTextureWrapper(10, 0));
            atexture.Add(4, Textures.mario_small_sheet.GetTextureWrapper(11, 0));

            // SWIM RIGHT
            atexture.Add(5, Textures.mario_small_sheet.GetTextureWrapper(8, 1));
            atexture.Add(5, Textures.mario_small_sheet.GetTextureWrapper(9, 1));
            atexture.Add(5, Textures.mario_small_sheet.GetTextureWrapper(10, 1));
            atexture.Add(5, Textures.mario_small_sheet.GetTextureWrapper(11, 1));

            // CROUCHING
            atexture.Add(6, Textures.mario_small_sheet.GetTextureWrapper(14, 0));
            atexture.Add(6, Textures.mario_small_sheet.GetTextureWrapper(14, 1));
