...
namespace SuperBitBros
{
    ...
    public class Program
    {
        ...
        public static BooleanKeySwitch debugSwitchZoom = new BooleanKeySwitch(false, Key.F1, KeyTriggerMode.FLICKER_DOWN);
        public static BooleanKeySwitch debugHPCheatSwitch = new BooleanKeySwitch(false, Key.F2, KeyTriggerMode.FLICKER_DOWN);
        ...
        public static BooleanKeySwitch debugKeyBindingSwitch = new BooleanKeySwitch(true, Key.F11, KeyTriggerMode.ON_DOWN);

        private static void Main(string[] args)
        {
            Console.Out.WriteLine("START");
            GameModel world = new GameWorld(0, 1);
